function y=KeffuncIDc(Es,ll,B,mf1k,alpha1k,mf2k,alpha2k,gJ,gI,Ehf,Ia,Ks,Kt,E6,sgn,~,~)
Kc=zeros(1,1);
...
for kk=2:Nc
    ...
    %chik(kk-1,kk-1)=chisnum0(Es+Eth0-Ethk,invchiks,Ek);
